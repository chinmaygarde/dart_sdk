...
#ifndef RUNTIME_BIN_EVENTHANDLER_QNX_H_
#define RUNTIME_BIN_EVENTHANDLER_QNX_H_

#if !defined(RUNTIME_BIN_EVENTHANDLER_H_)
#error Do not include eventhandler_qnx.h directly; use eventhandler.h instead.
#endif
...
#endif  // RUNTIME_BIN_EVENTHANDLER_QNX_H_
